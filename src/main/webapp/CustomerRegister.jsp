...
<tr>
  <td>EmailId</td>
  <td><input type="text" id="eid" name="emailId"></td>
  <td><span id="eidError" style="color :red ;"></span></td>
</tr>
<tr>
  <td>Password</td>
  <td><input type="text" id="cpass" name="password"></td>
  <td><span id="cpassError" style="color :red ;"></span></td>
</tr>
<tr>
  <td>ContactNumber</td>
  <td><input type="text" id="cno" name="contactNumber"></td>
  <td><span id="cnoError" style="color :red ;"></span></td>
</tr>
<tr>
  <td>Address</td>
  <td><input type="text" id="cadd" name="address"></td>
